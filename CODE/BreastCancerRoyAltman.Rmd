...
obstime <- dataBrestCancerTrain[rdata[,1]==1,"time"]

plot(timetoEvent,obstime,xlab="Expected time",ylab="Observed time",main="Expected vs. Observed",log="xy")

pander::pander(cor.test(timetoEvent,obstime,method="spearman"))

MADerror <- mean(abs(timetoEvent-obstime))
