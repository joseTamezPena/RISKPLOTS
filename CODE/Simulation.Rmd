...
source("~/Documents/GitHub/RISKPLOTS/simulate_events.R")
...
source("~/Documents/GitHub/RISKPLOTS/PlotRiskCategoriesAndTimetoEvent.R")
...
pander::pander(roc.test(RRAnalysisCI_LP$ROCAnalysis$ROC.analysis,RRAnalysisCI$ROCAnalysis$ROC.analysis))
